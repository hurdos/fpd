...
Скачиваем репозиторий, переходим внутрь директории проекта,
далее собираем билд и запускаем его.

```
docker-compose build
docker-compose up -d
docker exec fpd-fpm php app/test.php
```

Не забываем погасить контейнер после тестов.
